<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$Nav->addCustomNav("About this project", "http://www.eclipse.org/projects/project.php?id=modeling.gmt.viatra2", "_blank", 2);
...
<!-- VIATRA2 NEWS PART -->
		...
		<div class="homeitem">
			<h3>VIATRA2 News</h3>
				<ul class="midlist">
				<li>
				 <b>May 28<sup>th</sup>&nbsp;2012</b><br/>
				 EMF-IncQuery has been officially <a href="http://www.eclipse.org/proposals/modeling.emf.incquery/">proposed</a> as a new Eclipse.org subproject.
				</li>

				<li>
				 <b>April 11<sup>th</sup>&nbsp;2011</b><br/>
				 VIATRA2 Milestone 3.2 has been uploaded to our secondary <a href="http://static.inf.mit.bme.hu/viatra/update/nightly/">update site</a>. The milestone notes can be found on the <a href="http://wiki.eclipse.org/VIATRA2/ReleaseNotes3.2">Eclipse Wiki</a>, as always.
				</li>
				...
				<li>
				 ...
				 The IP contribution for the VIATRA2 Milestone 3.1 has been <a href="https://dev.eclipse.org/ipzilla/show_bug.cgi?id=3855#c15">approved</a>. Both the source and the update site archive is available from eclipse.org servers now, check out the downloads section.
              	</li>
				<li>
				 <b>April 12<sup>th</sup>&nbsp;2010</b><br/>
				 Check out the VIATRA2 milestone 3.1 video on <a href="http://vimeo.com/7412871">Vimeo.com</a>! The text is in Hungarian, but the screen captures towards the end highlight the most important features.
              	</li>
				<li>
				 <b>March 23<sup>th</sup>&nbsp;2010</b><br/>
				 VIATRA2 milestone 3.1 is finally complete. More information available at <a href="http://wiki.eclipse.org/VIATRA2/ReleaseNotes3.1">the milestone notes wiki page</a>.<br/>
                 For this milestone, we completely redesigned the VIATRA2 wiki and added lots of new content. This content is also included in the VIATRA2 online help.
                 The Rilestone3.1 source tree will be available from Eclipse.org SVN as well as the update site as soon as the IP check process is completed.
              	</li>
				<li>
				 ...
				 VIATRA2 project migration complete, we are now official part of the Modeling project (as the rest of GMT).<br/>
                  The homepage was updated with new sections, further additions to the wiki. The official milestone3 source tree is available from Eclipse.org SVN as well as our new update site (check the downloads section).
              	</li>
				<li>
				 <b>June 2<sup>th</sup>&nbsp;2008</b><br/>
				 New VIATRA2 milestone available: VIATRA2 milestone3 (update site:<a href="http://viatra.inf.mit.bme.hu/update/R2">http://viatra.inf.mit.bme.hu/update/R3</a><br/>
                  New homepage, wiki content under extension.
              	</li>
				
				<li>
				 <b>October 17<sup>th</sup>&nbsp;2007</b><br/>
                  New VIATRA2 milestone 2 update site available: <a href="http://viatra.inf.mit.bme.hu/update/R2">here</a><br/>
                  Expect a new homepage, new source archive and news soon.
              	</li>
              	<li>
                  <b>April 3<sup>th</sup>&nbsp;2007</b><br/>
                 New VIATRA2 milestone 2 CVS Snapshot available: <a href="download/viatra2r2_cvs20070401.zip">Download</a>
                </li>
				<li>
                  <b>October 10<sup>th</sup>&nbsp;2006</b><br/>
                 VIATRA2 milestone 2 docs updated: <a href="doc/viatratut_October2006.pdf">PDF</a><br/>
                  VIATRA2 milestone 2 CVS Snapshot available: <a href="download/viatra2r2_cvs20061010.zip">Download</a>
                </li>
				<li>
                  <b>July 28<sup>th</sup>&nbsp;2006</b><br/>
					VIATRA2 milestone 2 docs updated and are available for download from <a href="doc/viatratut2.pdf">here</a>
                </li>              
                 <li>
					<b>July 25<sup>th</sup>&nbsp;2006</b><br/>
                  VIATRA2 milestone 2 is now available Through the  <a href="http://arwen.mit.bme.hu:8080/viatraupdate">official update site</a>. (recommended version for the current milestone: Eclipse 3.1)
                   The new (milestone 2) sources are available under <a href="http://dev.eclipse.org/viewcvs/index.cgi/gmt-home/subprojects/VIATRA2/?cvsroot=Technology_Project">CVS</a>.
                </li>
